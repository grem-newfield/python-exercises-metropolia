...
async fn hello() -> impl Responder {
    HttpResponse::Ok().body("<h1>Hello There.</h1>")
}
...
#[derive(Debug, Serialize, Deserialize)]
pub struct AirportResponseJson {
    icao: String,
    name: String,
    location: String,
}

impl AirportResponseJson {
...
async fn get_airport(
    ...
    let body = web::Json(AirportResponseJson {
        icao: result.0,
        name: result.1,
        location: result.2,
    });
